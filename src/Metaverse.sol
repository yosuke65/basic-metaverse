...
contract Metaverse is ERC721, Ownable {
    ...
    // Total number of NFTs available for creation
    ...
    // Creation of the Buildings as a NFT Tokens in the Metaverse
    ...
    function getOwnerBuilding() public view returns (Building [] memory) {
